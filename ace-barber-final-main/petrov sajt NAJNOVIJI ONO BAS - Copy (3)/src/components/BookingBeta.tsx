      ...
      {showTimePicker && (
        <div className="fixed inset-0 z-[900] flex items-center justify-center bg-black/70 px-4 backdrop-blur-sm">
          <div className="relative w-full max-w-md rounded-3xl border border-border bg-card p-8 shadow-2xl">
            ...
            <h3 className="mb-1 text-center text-xl font-black uppercase tracking-widest">
              Izaberite Vreme
            </h3>
      ...
      <div className="mx-auto max-w-2xl">
        <Reveal className="mb-12">
          ...
          <p className="mt-4 text-muted-foreground">
            Izaberi frizera i zakaži termin za par sekundi — bez registracije.
          </p>
        </Reveal>
        ...
        <Reveal delay={0.1}>
          <form onSubmit={handleSubmit} className="space-y-6">
            {/* ── IZBOR FRIZERA ── */}
            <div>
              <label className="mb-3 block text-xs font-semibold uppercase tracking-[0.3em] text-accent">
                Izaberi frizera
              </label>
